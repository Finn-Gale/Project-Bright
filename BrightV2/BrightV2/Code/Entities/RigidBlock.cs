...
{
    class RigidBlock : GameEntity , IRigidCollide
    {
        //Instance Variables
        ...
        //DECLARE a bool to identify if the Rigid block collider needs to be removed form the game, call it '_mRigidRemove'
